...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn khanhdev.ddns.net của tôi.', 'color: #444; font-size: 25px; font-family: sans-serif;');
